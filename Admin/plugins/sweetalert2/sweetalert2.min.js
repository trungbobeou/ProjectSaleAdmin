! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() { "use strict";
    ...
    function q() { return e(F.close) }

    function I() { var t = m(K().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function(t, e) { return t = parseInt(t.getAttribute("tabindex")), (e = parseInt(e.getAttribute("tabindex"))) < t ? 1 : t < e ? -1 : 0 }),
    ...
    function j() { return !Y() && !document.body.classList.contains(F["no-backdrop"]) }

    function M(e, t) { if (e.textContent = "", t) { var n = (new DOMParser).parseFromString(t, "text/html");
            m(n.querySelector("head").childNodes).forEach(function(t) { e.appendChild(t) }), m(n.querySelector("body").childNodes).forEach(function(t) { e.appendChild(t) }) } }
    ...
    function Lt(t, e) { var n, o, i, r, a = O();
        R(a, e, "header"), Tt(0, e),
            ...
            function(t) { var e = x(); if (!t.imageUrl) return tt(e);
                G(e), e.setAttribute("src", t.imageUrl), e.setAttribute("alt", t.imageAlt), X(e, "width", t.imageWidth), X(e, "height", t.imageHeight), e.className = F.image, R(e, t, "image") }(e), n = e, o = C(), et(o, n.title || n.titleText), n.title && at(n.title, o), n.titleText && (o.innerText = n.titleText), R(o, n, "title"), i = e, r = q(), M(r, i.closeButtonHtml), R(r, i, "closeButton"), et(r, i.showCloseButton), r.setAttribute("aria-label", i.closeButtonAriaLabel) }

    function qt(t, e) { var n, o, i, r;
    ...
    function It() { return B() && B().click() } var jt = function() { for (var t = n(), e = 0; e < t.length; e++) tt(t[e]) },
    ...
    function ie(t, e, n, o) { n ? ce(t, o) : (Ut().then(function() { return ce(t, o) }), Kt.keydownTarget.removeEventListener("keydown", Kt.keydownHandler, { capture: Kt.keydownListenerCapture }), Kt.keydownHandlerAdded = !1), e.parentNode && !document.body.getAttribute("data-swal2-queue-step") && e.parentNode.removeChild(e), j() && (null !== Z.previousBodyPadding && (document.body.style.paddingRight = "".concat(Z.previousBodyPadding, "px"), Z.previousBodyPadding = null), function() { if (V(document.body, F.iosfix)) { var t = parseInt(document.body.style.top, 10);
    ...
    function fe(t) { var e = W(),
            n = K(); "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), Pe(e, n, t), ke(e, n), j() && xe(e, t.scrollbarPadding), Y() || Kt.previousActiveElement || (Kt.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() { return t.onOpen(n) }), lt(e, F["no-transition"]) }
    ...
    function ge(t, e) { t.disableButtons(), e.input ? qe(t, e) : Ie(t, e, !0) }
    ...
    function Ce(t, e, n) { Ct.innerParams.get(t).toast ? Ue(t, e, n) : (Fe(e), ze(e), We(t, e, n)) } var ke = function(t, e) { vt && nt(e) ? (t.style.overflowY = "hidden", e.addEventListener(vt, me)) : t.style.overflowY = "auto" },
        ...
        qe = function(e, n) { var o = function(t, e) { var n = t.getInput(); if (!n) return null; switch (e.input) {
                    case "checkbox":
                        return Ae(n);
                    case "radio":
                        return Be(n);
            ...
            n.inputValidator ? (e.disableInput(), Promise.resolve().then(function() { return n.inputValidator(o, n.validationMessage) }).then(function(t) { e.enableButtons(), e.enableInput(), t ? e.showValidationMessage(t) : Ie(e, n, o) })) : e.getInput().checkValidity() ? Ie(e, n, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage)) },
        Ie = function(e, t, n) {
        ...
        Re = function(t, e, n) { if (!e.isComposing && e.target && t.getInput() && e.target.outerHTML === t.getInput().outerHTML) { if (-1 !== ["textarea", "file"].indexOf(n.input)) return;
                It(), e.preventDefault() } },
        He = function(t) { for (var e = t.target, n = I(), o = -1, i = 0; i < n.length; i++)
                if (e === n[i]) { o = i; break }
        ...
        Je = Object.freeze({ hideLoading: Xt, disableLoading: Xt, getInput: function(t) { var e = Ct.innerParams.get(t || this),
                ...
                qt(this, i), Ct.innerParams.set(this, i), Object.defineProperties(this, { params: { value: c({}, this.params, e), writable: !1, enumerable: !0 } }) }, _destroy: function() { var t = Ct.domCache.get(this),
