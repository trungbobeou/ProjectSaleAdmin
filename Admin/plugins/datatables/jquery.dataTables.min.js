...
(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, H) { E || (E = window);
    ...
    function Ga(a, b) { var c = n.defaults.column,
    ...
    function Ia(a) {
        ...
        for (f = b.length; e < f; e++)
            ...
            g =
                0;
            for (j = d.length; g < j; g++) { i = 0; for (h = c.length; i < h; i++) { u[i] === k && (u[i] = B(a, i, e, "type"));
                    q = d[g](u[i], a); if (!q && g !== d.length - 1) break; if ("html" === q) break } if (q) { m.sType = q; break } }
            ...
            for (e = b.length - 1; 0 <= e; e--) {
                ...
                for (g = q.length; f < g; f++)
                    if ("number" === typeof q[f] && 0 <= q[f]) { for (; m.length <= q[f];) Ga(a);
                        d(q[f], l) } else if ("number" === typeof q[f] && 0 > q[f]) d(m.length +
                    q[f], l);
    ...
    function S(a) {
        ...
        if ("string" === typeof a &&
            ...
            var c = function(a, b, f) { var g, j; if ("" !== f) { j = La(f); for (var i = 0, l = j.length; i < l; i++) { f = j[i].match(da);
                        g = j[i].match(X); if (f) { j[i] = j[i].replace(da, ""); "" !== j[i] && (a = a[j[i]]);
                            g = [];
                            j.splice(0, i + 1);
                            j = j.join("."); if (h.isArray(a)) { i = 0; for (l = a.length; i < l; i++) g.push(c(a[i], b, j)) }
    ...
    function Ka(a, b, c, d) {
        var e = [],
            ...
            G = function(a) { if (c === k || c === i) j = m[i], l = h.trim(a.innerHTML), j && j._bAttrSrc ? (N(j.mData._)(d, l), u(j.mData.sort, a), u(j.mData.type, a), u(j.mData.filter, a)) : q ? (j._setter || (j._setter = N(j.mData)), j._setter(d, l)) : d[i] = l;
                i++ };
        if (f)
            for (; f;) {
        ...
        if (b) {
            ...
            for (e = g.length; d < e; d++) { if (a = g[d].nTr)
                ...
                f = 0; for (b = g[d].length; f < b; f++)
                    if (l = i = 1, j[d][f] === k) { a.appendChild(g[d][f].cell); for (j[d][f] = 1; g[d + i] !== k && g[d][f].cell == g[d + i][f].cell;) j[d + i][f] = 1, i++; for (; g[d][f + l] !== k && g[d][f].cell == g[d][f + l].cell;) { for (c = 0; c < i; c++) j[d + c][f + l] = 1;
                            l++ }
    ...
    function pb(a) {
        ...
        for (var f = a.sDom.split(""), g, j, i, l, m, q, k = 0; k < f.length; k++) {
            ...
            j = f[k];
            if ("<" == j) { i = h("<div/>")[0];
                l = f[k + 1]; if ("'" == l || '"' == l) { m = ""; for (q = 2; f[k + q] != l;) m += f[k + q], q++; "H" == m ? m = b.sJUIHeader : "F" == m && (m = b.sJUIFooter); - 1 != m.indexOf(".") ? (l = m.split("."), i.id = l[0].substr(1, l[0].length - 1), i.className = l[1]) : "#" == m.charAt(0) ? i.id = m.substr(1, m.length - 1) : i.className = m;
                    k += q }
                e.append(i);
    ...
    function ta(a, b, c) {
        ...
        l = { data: b, success: function(b) { var c = b.error || b.sError;
                c && K(a, 0, c);
                a.json = b;
    ...
    function wb(a) {
        ...
        d.bSort && (h.each(k, function(a, b) { G.order.push({ column: b.col, dir: b.dir });
            u("iSortCol_" + a, b.col);
            u("sSortDir_" + a, b.dir) }), u("iSortingCols", k.length));
        b = n.ext.legacy.ajax;
    ...
    function Ab(a) { for (var b = n.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length; f < g; f++) { for (var j = [], i = 0, l = c.length; i < l; i++) e = c[i], d = a.aoData[e], b[f](a, d._aFilterData, e, d._aData, i) && j.push(e);
            c.length = 0;
            h.merge(c, j) } }
    ...
    function yb(a, b, c, d, e, f) { var e = Ra(b, d, e, f),
            g = a.oPreviousSearch.sSearch,
            j = a.aiDisplayMaster,
            i, f = [];
        0 !== n.ext.search.length && (c = !0);
        i = Bb(a); if (0 >= b.length) a.aiDisplay = j.slice();
        else { if (i || c || d || g.length > b.length || 0 !== b.indexOf(g) || a.bSorted) a.aiDisplay = j.slice();
    ...
    function D(a, b) { a.oFeatures.bProcessing && h(a.aanFeatures.r).css("display", b ? "block" : "none");
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            h.each(sa(a,
                xa), function(b, c) { A = ba(a, b);
                c.style.width = a.aoColumns[A].sWidth });
            s && I(function(a) { a.style.width = "" }, R);
            f = p.outerWidth();
            if ("" === c) { t.width = "100%"; if (V && (p.find("tbody").height() > j.offsetHeight || "scroll" == m.css("overflow-y"))) t.width = w(p.outerWidth() - b);
                f = p.outerWidth() } else "" !== d && (t.width = w(d), f = p.outerWidth());
            I(B, L);
            ...
            I(function(a, b) { a.innerHTML = '<div class="dataTables_sizing">' + y[b] + "</div>";
                a.childNodes[0].style.height = "0";
                a.childNodes[0].style.overflow = "hidden";
                a.style.width = v[b] }, L);
            s && I(function(a, b) { a.innerHTML = '<div class="dataTables_sizing">' + z[b] + "</div>";
                a.childNodes[0].style.height = "0";
                a.childNodes[0].style.overflow = "hidden";
                a.style.width = x[b] }, R);
            if (p.outerWidth() < f) {
    ...
    function Jb(a, b) { var c = a.aoColumns[b],
            d = n.ext.order[c.sSortDataType],
            e;
        d && (e = d.call(a.oInstance, a, b, ca(a, b))); for (var f, g = n.ext.type.order[c.sType + "-pre"], j = 0, i = a.aoData.length; j < i; j++)
            if (c = a.aoData[j], c._aSortData || (c._aSortData = []), !c._aSortData[b] || d) f = d ? e[j] : B(a, j, b, "sort"), c._aSortData[b] = g ? g(f) : f }

    function za(a) {
        if (a.oFeatures.bStateSave &&
            !a.bDestroying) { var b = { time: +new Date, start: a._iDisplayStart, length: a._iDisplayLength, order: h.extend(!0, [], a.aaSorting), search: Cb(a.oPreviousSearch), columns: h.map(a.aoColumns, function(b, d) { return { visible: b.bVisible, search: Cb(a.aoPreSearchCols[d]) } }) };
    ...
    function Aa(a) { var b = n.settings,
    ...
    function Xa(a,
        b, c) { h(a).on("click.DT", b, function(b) { h(a).blur();
    ...
    function Fa(a) { h.each({ num: function(b) { return Ba(b, a) }, "num-fmt": function(b) { return Ba(b, a, Za) }, "html-num": function(b) { return Ba(b, a, Ca) }, "html-num-fmt": function(b) { return Ba(b, a, Ca, Za) } }, function(b, c) { v.type.order[b + a + "-pre"] = c;
    ...
    var n = function(a) {
            ...
            this.fnClearTable =
                function(a) { var b = this.api(!0).clear();
                    (a === k || a) && b.draw() };
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" +
                    ...
                    w.sUrl && (h.ajax({ dataType: "json", url: w.sUrl, success: function(a) { Ea(a);
                            J(m.oLanguage, a);
                            h.extend(true, w, a);
                            ia(p) }, error: function() { ia(p) } }), l = !0);
                    ...
                    if (null === g.aoColumns) { u = [];
                        j = 0; for (i = e.length; j < i; j++) u.push(null) } else u = g.aoColumns;
                    j = 0;
        ...
        ra = function(a) {
            ...
            a: {
                if (!(2 > a.length)) {
                    b = a.slice().sort();
                    for (var c = b[0], d = 1, e = b.length; d < e; d++) { if (b[d] === c) { b = !1; break a }
                        c = b[d] }
                }
                b = !0
            }
    ...
    n.util = { throttle: function(a, b) { var c = b !== k ? b : 200,
                ...
                d && g < d + c ? (clearTimeout(e), e = setTimeout(function() { d = k;
                    a.apply(b, j) }, c)) : (d = g, a.apply(b, j)) } }, escapeRegex: function(a) { return a.replace(ac, "\\$1") } };
    ...
    r = function(a, b) { if (!(this instanceof r)) return new r(a, b); var c = [],
            d = function(a) {
                (a = bc(a)) && c.push.apply(c, a) }; if (h.isArray(a))
    ...
    r.extend = function(a, b, c) {
        if (c.length &&
            b && (b instanceof r || b.__dt_wrapper)) { var d, e, f, g = function(a, b, c) { return function() { var d = b.apply(a, arguments);
                    r.extend(d, d, c.methodExt); return d } };
            d = 0; for (e = c.length; d < e; d++) f = c[d], b[f.name] = "function" === f.type ? g(a, f.val, f) : "object" === f.type ? {} : f.val, b[f.name].__dt_wrapper = !0, r.extend(a, b[f.name], f.propExt) }
    };
        ...
        if (h.isArray(a))
            ...
            for (var e = a.split("."), f = Tb, g, j, c = 0, d = e.length; c < d; c++) {
                g = (j = -1 !== e[c].indexOf("()")) ? e[c].replace("()",
                    "") : e[c];
                var i;
                a: { i = 0; for (var l = f.length; i < l; i++)
    ...
    r.registerPlural = s = function(a, b, c) { r.register(a, c);
    ...
    o("tables()", function(a) {
        var b;
        if (a) { b = r; var c = this.context; if ("number" === typeof a) a = [c[a]];
    ...
    var bb = function(a, b, c, d, e) {
            ...
            i = 0;
            for (l = b.length; i < l; i++) { j = b[i] && b[i].split && !b[i].match(/[\[\(:]/) ? b[i].split(",") : [b[i]];
                m = 0; for (n = j.length; m < n; m++)(g = c("string" === typeof j[m] ? h.trim(j[m]) : j[m])) && g.length && (f = f.concat(g)) }
            a = v.selector[a];
            ...
            c = this.iterator("table", function(c) {
                ...
                return bb("row", a, function(a) {
                        ...
                        if (a.nodeName) { var b = a._DT_RowIndex,
                                l = a._DT_CellIndex; if (b !== k) return i[b] && i[b].nTr === a ? [b] : []; if (l) return i[l.row] && i[l.row].nTr === a.parentNode ? [l.row] : [];
            ...
            c = this.iterator("table", function(c) {
                ...
                return bb("column", e, function(a) {
                    ...
                    if (k) switch (k[2]) {
                        case "visIdx":
                        case "visible":
                            b = parseInt(k[1], 10); if (b < 0) { var n = h.map(g, function(a, b) { return a.bVisible ? b : null }); return [n[n.length + b]] } return [ba(c, b)];
                        case "name":
        ...
        function(a, b) {
            var c = this,
                d = this.iterator("column", function(b, c) { if (a === k) return b.aoColumns[c].bVisible; var d = b.aoColumns,
                        j = d[c],
                        i = b.aoData,
                        l, m, n; if (a !== k && j.bVisible !== a) { if (a) { var o = h.inArray(!0, C(d, "bVisible"), c + 1);
                            l = 0; for (m = i.length; l < m; l++) n = i[l].nTr, d = i[l].anCells, n && n.insertBefore(d[c], d[o] || null) } else h(C(b.aoData, "anCells", c)).detach();
                        j.bVisible = a } });
        ...
        if (null === b || b === k) return this.iterator("table", function(b) {
            ...
            return bb("cell", d, function(a) {
                ...
                if (a === null || a === k || c) {
                    ...
                    s = 0;
                    for (r = g.length; s <
                        r; s++) { l = g[s]; for (t = 0; t < n; t++) { w = { row: l, column: t }; if (c) { v = f[l];
                                a(w, B(b, l, t), v.anCells ? v.anCells[t] : null) && o.push(w) } else o.push(w) } }
                    return o
                }
    ...
    n.versionCheck = n.fnVersionCheck = function(a) { for (var b = n.version.split("."), a = a.split("."), c, d, e = 0, f = a.length; e < f; e++)
        ...
        return !0 };
    n.isDataTable = n.fnIsDataTable = function(a) { var b = h(a).get(0),
                ...
                var g = a.oClasses,
                    ...
                    o = function(b, d) {
                        ...
                        for (s = d.length; k < s; k++) {
                            t = d[k];
                            if (h.isArray(t)) { r = h("<" + (t.DT_el || "div") + "/>").appendTo(b);
                                o(r, t) } else {
                                l = null;
                                m = t;
                                r = a.iTabIndex;
                                switch (t) {
                                    ...
                                    case "first":
                                        l = j.sFirst; if (e === 0) { r = -1;
                                            m = m + (" " + v) } break;
                                    case "previous":
                                        l = j.sPrevious; if (e === 0) { r = -1;
                                            m = m + (" " + v) } break;
                                    case "next":
                                        l = j.sNext; if (e === f - 1) { r = -1;
                                            m = m + (" " + v) } break;
                                    case "last":
                                        l = j.sLast; if (e === f - 1) { r = -1;
                                            m = m + (" " + v) } break;
                                    default:
                                        l = t + 1;
